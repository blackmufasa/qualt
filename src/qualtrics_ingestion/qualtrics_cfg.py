...
data_center = 'co1'
url4 = 'https://{data_center}.qualtrics.com/API/v3/survey-definitions/{survey_id}'
url1 = 'https://{data_center}.qualtrics.com/API/v3/surveys/{survey_id}'
...
table_2 = 'stg_qltrcs_srvy_hdr_new'
schema = 'rsdw_stg'
...
body_xlat_cols = repl_dict = {'surveyid': 'survey_id', 'responseid': 'response_id', 'responseset': 'response_set', 'startdate': 'start_date', 
                                'enddate': 'end_date', 'recipientlastname': 'recipient_last_name', 'recipientfirstname': 'recipient_first_name', 
                                'recipientemail': 'recipient_email', 'externaldatareference': 'external_data_reference', 
                                'case_accountnumber': 'case_account_number', 'case_casenumber': 'case_case_number', 
                                'case_createddate': 'case_created_date', 'case_lastclosedat': 'case_last_closed_at', 
                                'case_lastmodifieddate': 'case_last_modified_date', 'case_ownerid': 'case_owner_id', 
                                'case_recordtypedesc': 'case_record_type_desc', 'case_recordtypename': 'case_record_type_name', 
                                'cert_cataloglink': 'cert_catalog_link', 'current page url': 'current_page_url', 
                                'customer account number': 'customer_account_number', 'rh user id': 'rh_user_id', 'panelid': 'panel_id', 
                                'useragent': 'user_agent', 'q_totalduration': 'q_total_duration', 'eventname': 'event_name', 
...
body_col_order = ['data_row_number', 'survey_id', 'response_id', 'response_set', 'ipaddress', 'start_date', 'end_date',
                  ...
                  'cert_catalog_link', 'cert_identifier', 'closed_booked_opps', 'contact_city', 'contact_country_eloqua', 'contact_country_final',
                  ...
                  'contact_is_org_admin', 'contact_is_subscribed', 'contact_is_tam_contact', 'contact_is_viable',
                  'contact_job_persona', 'contact_job_role', 'contact_job_title_eloqua', 'contact_job_title_final',
                  'contact_job_title_sfdc', 'contact_last_nps_contact_role', 'contact_last_nps_email_sent_date','contact_lightblue_id',
                  'contact_null_fields','contact_phone', 'contact_preferred_language_eloqua', 'contact_preferred_language_sfdc',
                  ...
                  'csm_manager', 'csm_manager_email', 'csm_phone', 'csm_sso_username', 'csm_sub_geo', 'duns_number' ,'duplicate_count',
                  'ebs_account_number', 'ebs_account_number_account', 'ebs_account_number_contact' ,'eloqua_contact_id', 'first_booked_opp',
                  'first_booked_opp_month', 'first_sub_start_date', 'first_sub_start_date_month', 'interaction_status',
...
# All the numeric columns are scrubbed so that blank fields are properly initialized
...
# All the boolean columns that have datatype as string in database are scrubbed so that there are no truncation
bool_cols = ['complete', 'completed']
...
sql_cmd_list = [sql1, sql2, sql3, sql4, sql5, sql6, sql7, sql8, sql9, sql10, sql11]
